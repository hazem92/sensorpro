...
public:
  ...
  void setSensor_periodicity_lcm(int t);
 ...
 */
  ...
  Data addData (Data *data, short id_sensor);
   ...
   * @param  frequency
   */
  void setDataSendPeriode (short sensor_id, short data_id, int periode) ;
